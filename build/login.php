        ...
        <div class="container mx-auto px-24 py-24">
            <div class="flex flex-wrap -m-4">
                <div class="p-4 md:w-3/5">
                    <div class="mb-6">
                        <h3 class="font-medium leading-tight text-3xl mt-0 mb-2 text-blue-500">
                            Logo here
                        </h3>
                ...
                <div class="p-4 md:w-2/5">
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="shadow-xl rounded-xl px-8 pt-6 pb-8 mb-4" style="background-color: rgb(36,37,38);">
                        ...
                        <div class="mb-6">
                            <input class="shadow appearance-none rounded w-full py-3 px-3 text-white leading-tight focus:outline-none focus:shadow-outline" name="password" id="password" type="password" placeholder="Password" style="background-color: rgb(58,59,60);">
                        </div>
                        <div class="mb-6">
                        ...
                        <div class="mb-6">
                            <a class="flex m-auto justify-center font-bold text-sm text-blue-500 hover:text-blue-600" href="#">
                                Forgot Password?
                            </a>
                        </div>
                        <hr>
