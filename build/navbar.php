...
<nav class="w-full bg-white shadow-md h-16 flex justify-between" style="background-color: #242526">
    <div class="w-full lg:w-4/6 xl:w-full  h-full flex items-center px-4 ">
        ...
        <div class="relative mx-3" x-data="{dropdown : false}">
            <input @click="dropdown = !dropdown" @click.away="dropdown = false" type="text" name="" id="" class="relative z-30 text-md justify-center w-8 h-8 lg:w-10 lg:h-10 xl:w-56 bg-gray-200 rounded-full  xl:px-10 py-2 focus:outline-none placeholder-gray-200 xl:placeholder-gray-600 " placeholder="cari di facebook">
    ...
    <div class="hidden md:flex w-full  h-full justify-center">
        ...
        <div class="border-b-4">
            <button class="flex items-center h-full md:w-16 lg:w-24 xl:w-32 justify-center focus:outline-none rounded-md">
                <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 24 24" fill="none" stroke="#b0b0b0" stroke-width="3" stroke-linecap="square" stroke-linejoin="round">
        ...
        <div class="border-b-4">
            <button class="flex items-center h-full md:w-16 lg:w-24 xl:w-32 justify-center hover:border-blue-600 focus:outline-none rounded-md">
    ...
    <div class="w-full  h-full flex justify-end space-x-2 items-center px-3">
        <div x-data="{ open: false }">
            ...
            <ul x-show="open" @click.away="open = false" class="absolute bg-white w-32 shadow-md py-3 px-2">
                <a class="w-full h-5" href="{{ route('logout') }}" onclick="event.preventDefault();
        ...
        <button class="w-8 h-8 lg:h-10 lg:w-10 bg-gray-300 focus:outline-none hover:bg-gray-400 rounded-full flex items-center justify-center">
            <svg class="w-4 h-4 lg:w-6 lg:h-6 fill-current text-gray-600 stroke-current " xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 24 24" fill="none" stroke="#b0b0b0" stroke-width="3" stroke-linecap="square" stroke-linejoin="round">
                <line x1="12" y1="5" x2="12" y2="19"></line>
                <line x1="5" y1="12" x2="19" y2="12"></line>
            </svg>
        </button>
        <button class="w-8 h-8 lg:h-10 lg:w-10 bg-gray-300 focus:outline-none hover:bg-gray-400 rounded-full flex items-center justify-center">
            <svg class="w-4 h-4 lg:w-6 lg:h-6 fill-current text-gray-600 stroke-current " xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 24 24" fill="none" stroke="#b0b0b0" stroke-width="2" stroke-linecap="square" stroke-linejoin="round">
